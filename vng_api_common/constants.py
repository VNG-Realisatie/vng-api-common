...
class ComponentTypes(DjangoChoices):
    ...
    wrc = ChoiceItem("wrc", "WebResourceComponent")
    ...
    orc = ChoiceItem("orc", "OrderRegistratieComponent")
    lc = ChoiceItem("lc", "LocatieComponent")
    vtc = ChoiceItem("vtc", "VerzoekTypeComponent")
    vrc = ChoiceItem("vrc", "VerzoekRegistratieComponent")
    bc = ChoiceItem("bc", "BetaalService")
    brp = ChoiceItem("brp", "BasisRegistratiePersonen")
    bs = ChoiceItem("bs", "BerichtenService")
    db = ChoiceItem("db", "DashboardComponent")
    zac = ChoiceItem("zac", "ZaakAfhandelComponent")
    pc = ChoiceItem("pc", "ProcesComponent")
    ui = ChoiceItem("ui", "UserInterface")
    auth = ChoiceItem("auth", "AuthenticatieComponent")
