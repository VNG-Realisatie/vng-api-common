...
def forward(apps, schema_editor):
    ...
    AuthorizationsConfig.objects.all().update(
    ...
    Autorisatie.objects.all().update(
        component=Lower(F('component')),
        max_vertrouwelijkheidaanduiding=Lower(Replace(F('max_vertrouwelijkheidaanduiding'), Value(' '), Value('_')))
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authorizations', '0008_auto_20190712_1541'),
    ]
